        ...
        <div class="container-fluid">
            ...
            <?php if (!isset($_SESSION) OR (empty($_SESSION))): ?>
                ...
                <div style="margin-top:8px;">
                    <button style="float:right" data-toggle="modal" data-target="#registerModal" class="btn btn-danger">
                        Register
                    </button>
                </div>
            <?php else: ?>
                    ...
                    <div class="row main col-xs-10 col-xs-offset-1">
                        ...
                        <div class="main-login main-center">
                            <form class="form-horizontal" method="post">
                                    ...
                                    <div class="cols-sm-10">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-users fa"
                                                                               aria-hidden="true"></i></span>
                                            <input type="text" class="form-control" name="registrationUsername"
                                ...
                                <div class="form-group ">
                                    <button name="registrationForm" type="submit"
